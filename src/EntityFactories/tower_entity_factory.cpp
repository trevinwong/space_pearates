...
Entity TowerEntityFactory::createWaterTower(glm::vec2 towerCenterBottomPosition, glm::vec2 _size)
{
  Entity towerEntity;
  // calculate left top x,y coord
  float x = towerCenterBottomPosition.x - _size.x / 2.0;
  ...
  WaterTowerAttackComponent *waterTowerAttackComponent =
    new WaterTowerAttackComponent(relativeFirePosition, attackRange, maxLevel, slowDownFactor);
  ...
  towerEntity.setComponent<HealthComponent>(health);
  towerEntity.setComponent<TowerMetaComponent>(towerMetaComponent);
  towerEntity.setComponent<WaterTowerAttackComponent>(waterTowerAttackComponent);
  towerEntity.setComponent<TowerRangeSpriteComponent>(towerRangeSpriteComponent);
